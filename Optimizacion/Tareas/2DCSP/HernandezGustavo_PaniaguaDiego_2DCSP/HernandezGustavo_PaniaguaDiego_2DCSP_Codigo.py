...
class GRASP2DCSP:
    ...
    def __init__(self, sheet_size: Tuple[int, int], piece_types: List[PieceType],
        ...
        self.penalty_coef = penalty_coef if penalty_coef is not None else self.B * self.H
    ...
    def construct(self):
        ...
        waste = self.compute_waste(placed, unplaced)          # Calcula area desperdiciada
    ...
    def _apply_swap(self, sol: Solution, p: Piece, q: Piece,
        ...
        new_sol.waste_area = self.compute_waste(new_sol.placed, new_sol.unplaced)
        return new_sol
    ...
    def compute_waste(self, placed, unplaced):
        """Devuelve el área desperdiciada si toda la demanda fue colocada, o infinito si quedó alguna pieza sin ubicar."""
...
if __name__ == "__main__":
    ...
    def mostrar_resultado(sheet, sol_mc, sol_bl, types, title):
        ...
        # Aviso de inviabilidad
        if sol_bl.waste_area == float('inf'):
            print("➔ No se logró colocar toda la demanda en una sola lámina. Solución inviable.\n")
