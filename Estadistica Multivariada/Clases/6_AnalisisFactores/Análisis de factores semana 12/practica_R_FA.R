...
cortest.bartlett(varcoches_corr,n)
...
varcoches_corr #matriz de correlación real(observada)
...
#el factor 1 es el que está influyendo en el comportamiento fuera de rango del
#coche
